...
<body>
    <div class="container">
        ...
        <p>Nombre Completo: <?php echo e($fullname); ?></p>
        <p>Correo Electronico: <?php echo e($email); ?></p>
        <p>Numero Telefonico: <?php echo e($cellphone); ?></p>
...
<?php /**PATH C:\xampp\htdocs\lurichamba-web\resources\views/emails/entrepreneur-notification.blade.php ENDPATH**/ ?>