...
<body>
    ...
    <script>
        ...
        // Los participantes se pasan desde el backend y se convierten a un array de objetos JavaScript
        const participantes = <?php echo json_encode($participantes_tickets, 15, 512) ?>;

        let intervaloConteo;
        let intervaloSeleccion;
        let tiempoRestante = 20;
        let velocidadSeleccion = 0.001;
        ...
        function iniciarConteo() {
            ...
            loading.classList.add('loading-start');
        ...
        function seleccionarParticipante() {
            intervaloSeleccion = setInterval(() => {
                ...
                participanteActualElement.textContent = participanteActual.NroTiket;

                this.ticket = participanteActual.NroTiket;
                this.codigo_contri = participanteActual.personaId;
                if (tiempoRestante > 0) {
                    clearInterval(intervaloSeleccion);
                    velocidadSeleccion += 0.50; // Incrementa el tiempo entre selecciones
                    seleccionarParticipante();
                }
            }, velocidadSeleccion);
        }
        ...
        function mostrarGanador() {
            ...
            ganador.textContent = `Ganador: ${this.ticket} (ID: ${this.codigo_contri})`;

            // ganador.textContent = this.codigo_contri;

            loading.classList.add('loading');
            loading.classList.remove('loading-start');
...
<?php /**PATH C:\xampp\htdocs\portal-trabajo-mdsjl_03_05_2024\portal-trabajo-mdsjl\resources\views/sorteos/index.blade.php ENDPATH**/ ?>