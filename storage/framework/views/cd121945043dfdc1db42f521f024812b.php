            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('especialidad.index')); ?>">Tipo Servicios</a>
                        </li>
                    ...
                    <div class="card-body">
                        ...
                        <table id="result-table" class="table table-responsive  datatables-basic dtr-column collapsed ">
                            ...
                            <tbody id="result-table">
                                ...
                                <?php $__currentLoopData = $tipoServicios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo_servicio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <a href="#" class="btn btn-primary btn-sm">
                                                <?php echo e($tipo_servicio->id); ?>
                                        ...
                                        <td>
                                            <a href="#" class="btn-modal-foto" data-bs-toggle="modal"
                                                data-bs-target="#fotoModal" data-id="<?php echo e($tipo_servicio->id); ?>"
                                                data-foto="<?php echo e(Storage::url($tipo_servicio->icono_url) ?? 'https://marketplace.canva.com/EAFbDgiv63c/1/0/1600w/canva-certificado-taller-de-administraci%C3%B3n-simple-azul-y-amarillo-Y-NyNpF3uqE.jpg'); ?>">
                                                <?php echo e($tipo_servicio->nombres ?? 'No existe descripción.....'); ?>

                                            </a>
                                        </td>
                                        <td>
                                            <button
                                                class="btn <?php echo e($tipo_servicio->estado == '1' ? 'btn-success' : 'btn-danger'); ?>">
                                                <?php echo e($tipo_servicio->estado == '1' ? 'Habilitado' : 'Deshabilitado'); ?>
                                        ...
                                        <td>
                                            ...
                                            <form action="<?php echo e(route('tipo-servicio.destroy', $tipo_servicio)); ?>"
                                                ...
                                                <a href="#" class="btn btn-primary dt-button create-new"
                                                    ...
                                                    data-id="<?php echo e($tipo_servicio->slug); ?>"
                                                    data-nombres="<?php echo e($tipo_servicio->nombres); ?>"
                                                    data-slug="<?php echo e($tipo_servicio->slug); ?>">
                                                ...
                                                <button type="submit"
                                                    class="btn btn-danger <?php echo e($tipo_servicio->estado == '2' ? 'disabled' : ''); ?>">
                                        ...
                                        <td class="text-center">
                                            <ul class="table-controls">
                                                <form action="<?php echo e(route('tipo-servicio.activar', $tipo_servicio)); ?>"
                                                    method="POST" class="activar">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('POST'); ?>
                                                    <button type="submit"
                                                        class="btn btn-success <?php echo e($tipo_servicio->estado == '1' ? 'disabled' : ''); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-1">
                                ...
                                <div id="result-info" class="dataTables_info">
                                    Mostrando <?php echo e($tipoServicios->firstItem()); ?> a <?php echo e($tipoServicios->lastItem()); ?> de
                                    <?php echo e($tipoServicios->total()); ?> registros
                                </div>
                            ...
                            <div class="col-md-6">
                                <div id="result-pagination" class="dataTables_paginate">
                                    <ul class="pagination justify-content-end">
                                        <li class="page-item <?php echo e($tipoServicios->previousPageUrl() ? '' : 'disabled'); ?>">
                                            <a class="page-link"
                                                href="<?php echo e($tipoServicios->previousPageUrl()); ?>">Anterior</a>
                                        </li>

                                        <?php if($tipoServicios->currentPage() > 3): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="<?php echo e($tipoServicios->url(1)); ?>">1</a>
                                            </li>
                                            <?php if($tipoServicios->currentPage() > 4): ?>
                                        ...
                                        <?php $__currentLoopData = $tipoServicios->getUrlRange(max($tipoServicios->currentPage() - 2, 1), min($tipoServicios->currentPage() + 2, $tipoServicios->lastPage())); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li
                                                class="page-item <?php echo e($page == $tipoServicios->currentPage() ? 'active' : ''); ?>">
                                                <a class="page-link" href="<?php echo e($url); ?>"><?php echo e($page); ?></a>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                        <?php if($tipoServicios->currentPage() < $tipoServicios->lastPage() - 2): ?>
                                            <?php if($tipoServicios->currentPage() < $tipoServicios->lastPage() - 3): ?>
                                                <li class="page-item disabled">
                                                    <span class="page-link">...</span>
                                                </li>
                                            <?php endif; ?>
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="<?php echo e($tipoServicios->url($tipoServicios->lastPage())); ?>"><?php echo e($tipoServicios->lastPage()); ?></a>
                                            </li>
                                        <?php endif; ?>

                                        <li class="page-item <?php echo e($tipoServicios->nextPageUrl() ? '' : 'disabled'); ?>">
                                            <a class="page-link" href="<?php echo e($tipoServicios->nextPageUrl()); ?>">Siguiente</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        ...
                        <form id="editAddForm" class="row gy-1 pt-75 formguardar"
                            action="<?php echo e(route('tipo-servicio.store')); ?>" method="POST" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
        ...
        <?php echo $__env->make('tipo-servicios.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        ...
                        <form id="formActualizarImagen" class="row gy-1 pt-75 actualizarFoto"
                            action="<?php echo e(route('tipo-servicio.actualizarImagen', 2)); ?>" method="POST"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.dt-button.create-new').click(function() {
                ...
                var actionUrl = "<?php echo e(route('tipo-servicio.update', ':id')); ?>";
            ...
            $('.imagen-actualizar').click(function() {
                var id = $(this).data('id');
                var actionUrl = "<?php echo e(route('tipo-servicio.actualizarImagen', ':id')); ?>";
                actionUrl = actionUrl.replace(':id', id);
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lurichamba-web\resources\views/tipo-servicios/index.blade.php ENDPATH**/ ?>