                                            ...
                                            <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link d-grid gap-2  btn-lg" id="pills-profile-tab"
                                                        ...
                                                        aria-selected="false">CONTRATAR SERVICIO</button>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="card"
                                                ...
                                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                                    ...
                                                    <div class="card-body">
                                                        <h2 class="section-title text-center mb-15 wow animate__ animate__fadeInUp animated"
                                                            style="visibility: visible; animation-name: fadeInUp;">Registro
                                                        </h2>
                                                        <?php if($errors->any()): ?>
                                                        ...
                                                        <form class="contact-form-style" id="contact-form"
                                                            action="<?php echo e(route('registrate.ofrecerServicio')); ?>"
                                                            ...
                                                            <div class="row wow animate__animated animate__fadeInUp"
                                                                ...
                                                                <div class="col-lg-12 col-md-12">
                                                                    <div class="input-style mb-20">
                                                                        <label
                                                                            class="form-label text-lg font-weight-bold mr-3"
                                                                            for="numero_documento"
                                                                            style="font-weight: bold">*
                                                                            Tipo de Documento:</label>
                                                                        <select name="tipo_documento_id"
                                                                            id="tipo_documento_id"
                                                                            onchange="capturarValorSeleccionado()"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-lg-6 col-md-6">
                                                                    <div class="input-style mb-20">
                                                                        <label
                                                                            class="form-label text-lg font-weight-bold mr-3"
                                                                            for="nombres" style="font-weight: bold">*
                                                                            Numero de celular:</label>
                                                                        <input class="form-control" id="numero_celular"
                                                                            type="text" name="numero_celular"
                                                                ...
                                                                <div class="col-lg-12 col-md-6">
                                                                    <div class="input-style mb-20">
                                                                        <label
                                                                            class="form-label text-lg font-weight-bold mr-3"
                                                                            for="direccion_fiscal"
                                                                            style="font-weight: bold">*
                                                                            Dirección Fiscal:</label>
                                                                        <input name="direccion_fiscal"
                                                                            id="direccion_fiscal"
                                                                            placeholder="Ingrese Su Domicilio Fiscal"
                                                                            type="text"
                                                                            value="<?php echo e(old('direccion_fiscal')); ?>"
                                                                            required />
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 text-center">
                                                                        <div class="input-style mb-20">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" id="aceptacion_termino"
                                                                                value="1" name="aceptacion_termino"
                                                                                required>
                                            ...
                                            <div class="tab-pane" id="pills-profile" role="tabpanel"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="contact-form-style" id="contact-form"
                                                        action="<?php echo e(route('registrar.contratarServicio')); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        <div class="row wow animate__animated animate__fadeInUp"
                                                            data-wow-delay=".1s">
                                                            ...
                                                            <div class="col-lg-6 col-md-6">
                                                                <div class="input-style mb-20">
                                                                    <label class="form-label text-lg font-weight-bold mr-3"
                                                                        for="numero_documento" style="font-weight: bold">*
                                                                        Número de Documento:</label>
                                                                    <input class="form-control" id="numero_documento1"
                                                                        type="text" name="numero_documento1"
                                                                        placeholder="Ingrese N° Documento"
                                                                        value="<?php echo e(old('numero_documento')); ?>" required
                                                                        onkeypress="return solonumeros(event)" />
                                                                </div>
                                                            ...
                                                            <!-- <div class="col-lg-12 col-md-12">
                                                                <div class="input-style mb-20">
                                                                    ...
                                                                    <input class="form-control" type="text"
                                                                        ...
                                                                        value="<?php echo e(old('ruc')); ?>" required
                                                                        onkeypress="return solonumeros(event)" />
                                                                </div>
                                                            </div> -->
                                                            ...
                                                            <div class="col-lg-6 col-md-6">
                                                                <div class="input-style mb-20">
                                                                    <label class="form-label text-lg font-weight-bold mr-3"
                                                                        for="nombres" style="font-weight: bold">*
                                                                        Numero de celular:</label>
                                                                    <input class="form-control" id="numero_celular1"
                                                                        type="text" name="numero_celular1"
                                                                        placeholder="Ingrese su celular"
                                                                        autocomplete="new-username"
                                                                        value="<?php echo e(old('numero_celular')); ?>" required
                                                                        onkeypress="return solonumeros(event)" />
                                                            ...
                                                            <div class="col-lg-12 col-md-6">
                                                                <div class="input-style mb-20">
                                                                    <label class="form-label text-lg font-weight-bold mr-3"
                                                                        for="nombres" style="font-weight: bold">*
                                                                        Nombres:</label>
                                                                    <input class="form-control" id="nombres1"
                                                                        type="text" name="nombres1"
                                                                        placeholder="Ingrese Su Nombre Completo"
                                                                        autocomplete="new-username"
                                                                        value="<?php echo e(old('nombres')); ?>" required
                                                                        onkeypress="return soloLetrasTildesNombreCampo(event)" />
                                                            ...
                                                            <div class="col-lg-6 col-md-6">
                                                                <div class="input-style mb-20">
                                                                    <label class="form-label text-lg font-weight-bold mr-3"
                                                                        ...
                                                                        Apellido Paterno:</label>
                                                                    <input name="apellido_paterno1" id="apellido_paterno1"
                                                                        placeholder="Ingrese Su Apellido Paterno"
                                                                        type="text"
                                                                        value="<?php echo e(old('apellido_paterno')); ?>" required
                                                                        onkeypress="return soloLetrasTildesNombreCampo(event)" />
                                                            ...
                                                            <div class="col-lg-6 col-md-6">
                                                                <div class="input-style mb-20">
                                                                    ...
                                                                    <input name="apellido_materno1" id="apellido_materno1"
                                                                        placeholder="Ingrese Su Apellido Materno"
                                                                        type="text"
                                                                        value="<?php echo e(old('apellido_materno')); ?>" required
                                                                        onkeypress="return soloLetrasTildesNombreCampo(event)" />
                                                            ...
                                                            <div class="col-lg-12 col-md-6">
                                                                <div class="input-style mb-20">
                                                                    <label class="form-label text-lg font-weight-bold mr-3"
                                                                        ...
                                                                        Dirección Fiscal:</label>
                                                                    <input name="direccion_fiscal1" id="direccion_fiscal1"
                                                                        placeholder="Ingrese Su Domicilio Fiscal"
                                                                        type="text"
                                                            ...
                                                            <div class="col-lg-12 col-md-12">
                                                                <div class="input-style mb-20">
                                                                    <label class="form-label text-lg font-weight-bold mr-3"
                                                                        for="login-password" style="font-weight: bold">*
                                                                        Correo:</label>
                                                                    <input name="email" id="email"
                                                                        class="form-control"
                                                                        placeholder="Ingrese Su Correo" type="email"
                                                            ...
                                                            <div class="col-lg-12 col-md-12 text-center">
                                                                <div class="input-style mb-20">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        id="aceptacion_termino1" value="1"
                                                                        name="aceptacion_termino1" required>
                                                                    <label class="form-check-label"
                                                                        for="flexCheckDefault">
                                                                        Estoy de acuerdo con los <a href="#">Terminos
                                                                            y Condiciones.</a>
                                                                    </label>
                                                                </div>
                                                            </div>
