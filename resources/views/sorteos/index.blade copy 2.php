...
<body>
    ...
    <script>
        ...
        let participantes = [...lista.querySelectorAll('li')].map(li => li.textContent);
        let intervalo;
        ...
        function mostrarGanador() {
            ...
            ganador.textContent = participanteGanador;
            // resultado.classList.add('show');
            resultado.style.display = 'show';
        ...
        function cerrarModal() {
            ...
            participantes = [...lista.querySelectorAll('li')].map(li => li.textContent);
        }
