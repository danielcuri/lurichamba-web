...
<body>
    ...
    <script>
        ...
        function iniciarConteo() {
            ...
            tiempoRestante = parseInt(contador.textContent);
            actualizarConteo();
        }

        function actualizarConteo() {
            let numeroActual = tiempoRestante;
            let velocidad = calcularVelocidad(numeroActual);
            intervalo = setInterval(() => {
                ...
                if (numeroActual <= 0) {
                    ...
                    clearInterval(intervalo);
                    tiempoRestante = numeroActual;
                    actualizarConteo();
                }
            }, velocidad);
        }

        function calcularVelocidad(numeroActual) {
            return 50 + (20 - numeroActual) * 50;
        }
