                            ...
                            <div class="col-xl-9 col-md-12 mx-auto">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <form class="contact-form-style" id="contact-form" action="{{ route('registrate.ofrecerServicio') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="input-style mb-20">
                                                        ...
                                                        <select name="tipo_documento_id" id="tipo_documento_id" onchange="capturarValorSeleccionado()" class="form-control" value="{{old('tipo_documento_id')}}" required>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="input-style mb-20">
                                                        ...
                                                        <input class="form-control" id="numero_documento" type="text" name="numero_documento" placeholder="Ingrese N° Documento" value="{{old('numero_documento')}}" required onkeypress="return solonumeros(event)" />
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-style mb-20">
                                                            ...
                                                            <input class="form-control" id="numero_celular" type="text" name="numero_celular" placeholder="Ingrese su celular" autocomplete="new-username" value="{{old('numero_celular')}}" required onkeypress="return solonumeros(event)" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12">
                                                        <div class="input-style mb-20">
                                                            <label class="form-label text-lg font-weight-bold mr-3" for="ruc" style="font-weight: bold">*
                                                                RUC:</label>
                                                            <input class="form-control" id="ruc" type="text" name="ruc" placeholder="Ingrese su RUC" value="{{old('ruc')}}"  onkeypress="return solonumeros(event)" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-6">
                                                        <div class="input-style mb-20">
                                                            <label class="form-label text-lg font-weight-bold mr-3" for="nombres" style="font-weight: bold">*
                                                                Nombres:</label>
                                                            <input class="form-control" id="nombres" type="text" name="nombres" placeholder="Ingrese Su Nombre Completo" autocomplete="new-username" value="{{old('nombres')}}" required onkeypress="return soloLetrasTildesNombreCampo(event)" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-style mb-20">
                                                            ...
                                                            <input name="apellido_paterno" id="apellido_paterno" placeholder="Ingrese Su Apellido Paterno" type="text" value="{{old('apellido_paterno')}}" required onkeypress="return soloLetrasTildesNombreCampo(event)" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-style mb-20">
                                                            ...
                                                            <input name="apellido_materno" id="apellido_materno" placeholder="Ingrese Su Apellido Materno" type="text" value="{{old('apellido_materno')}}" required onkeypress="return soloLetrasTildesNombreCampo(event)" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-6">
                                                        <div class="input-style mb-20">
                                                            ...
                                                            <input name="direccion_fiscal" id="direccion_fiscal" placeholder="Ingrese Su Domicilio Fiscal" type="text" value="{{old('direccion_fiscal')}}" required />
                                                    ...
                                                    <div class="col-lg-12 col-md-6">
                                                        <div class="input-style mb-20">
                                                            ...
                                                            <input class="form-control" name="file" id="file" type="file" accept=".pdf" placeholder=""  value="{{old('file')}}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="input-style mb-20">
                                                        ...
                                                        <input name="email" id="email" class="form-control" placeholder="Ingrese Su Correo" type="email" value="{{ old('email', request('email') ?? '') }}" required />
                                                    </div>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <form class="contact-form-style" id="contact-form" action="{{ route('registrar.contratarServicio') }}" method="POST">
                                                @csrf
                                                <div class="row wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                                                    ...
                                                    <div class="col-lg-12 col-md-12">
                                                        <div class="input-style mb-20">
                                                            <label class="form-label text-lg font-weight-bold mr-3" for="numero_documento" style="font-weight: bold">*
                                                                Tipo de Documento:</label>
                                                            <select name="tipo_documento_id" id="tipo_documento_id1" onchange="capturarValorSeleccionado()" class="form-control" value="{{old('tipo_documento_id')}}" required>
                                                                <option value="" selected disabled>Seleccione tipo de documento</option>
                                                                @foreach ($tipo_documentos as $tipo_documento)
                                                                <option value="{{ $tipo_documento->id }}">
                                                                    {{ $tipo_documento->nombres }}
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-style mb-20">
                                                            <label class="form-label text-lg font-weight-bold mr-3" for="numero_documento" style="font-weight: bold">*
                                                                Número de Documento:</label>
                                                            <input class="form-control" id="numero_documento1" type="text" name="numero_documento1" placeholder="Ingrese N° Documento" value="{{old('numero_documento')}}" required onkeypress="return solonumeros(event)" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12">
                                                        <div class="input-style mb-20">
                                                            <label class="form-label text-lg font-weight-bold mr-3" for="ruc" style="font-weight: bold">*
                                                                RUC:</label>
                                                            <input class="form-control" type="text" name="ruc" placeholder="Ingrese su RUC" value="{{old('ruc')}}" required onkeypress="return solonumeros(event)" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-style mb-20">
                                                            <label class="form-label text-lg font-weight-bold mr-3" for="nombres" style="font-weight: bold">*
                                                                Numero de celular:</label>
                                                            <input class="form-control" id="numero_celular1" type="text" name="numero_celular1" placeholder="Ingrese su celular" autocomplete="new-username" value="{{old('numero_celular')}}" required onkeypress="return solonumeros(event)" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-6">
                                                        <div class="input-style mb-20">
                                                            <label class="form-label text-lg font-weight-bold mr-3" for="nombres" style="font-weight: bold">*
                                                                Nombres:</label>
                                                            <input class="form-control" id="nombres1" type="text" name="nombres1" placeholder="Ingrese Su Nombre Completo" autocomplete="new-username" value="{{old('nombres')}}" required onkeypress="return soloLetrasTildesNombreCampo(event)" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-style mb-20">
                                                            <label class="form-label text-lg font-weight-bold mr-3" for="apellido_paterno" style="font-weight: bold">*
                                                                Apellido Paterno:</label>
                                                            <input name="apellido_paterno1" id="apellido_paterno1" placeholder="Ingrese Su Apellido Paterno" type="text" value="{{old('apellido_paterno')}}" required onkeypress="return soloLetrasTildesNombreCampo(event)" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-style mb-20">
                                                            ...
                                                            <input name="apellido_materno1" id="apellido_materno1" placeholder="Ingrese Su Apellido Materno" type="text" value="{{old('apellido_materno')}}" required onkeypress="return soloLetrasTildesNombreCampo(event)" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-6">
                                                        <div class="input-style mb-20">
                                                            <label class="form-label text-lg font-weight-bold mr-3" for="direccion_fiscal" style="font-weight: bold">*
                                                                Dirección Fiscal:</label>
                                                            <input name="direccion_fiscal1" id="direccion_fiscal1" placeholder="Ingrese Su Domicilio Fiscal" type="text" value="{{old('direccion_fiscal')}}" required />
