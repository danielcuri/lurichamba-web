...
<head>
    ...
    <!-- Template CSS -->
    <link rel="stylesheet" href="{{ asset('portal/assets/css/plugins/animate.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('portal/assets/css/main.css?v=1.0') }}" />
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@800;900&display=swap" rel="stylesheet">

    <link rel="stylesheet" href="{{asset('portal/font-awesome.min.css')}}">
    {{-- <link rel="stylesheet" href="{{asset('awesome-all.min.css') }}"> --}}
...
<body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                <div class="text-center">
                    <img src="{{ asset('portal/assets/imgs/theme/loading.gif') }}" alt="jobhub" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-xs-6">
                    ...
                    <ul class="menu-footer mt-40">
                        ...
                        <li><a href="{{route('portal.politicasPrivacidad')}}" target="_blank">Políticas y Privacidad</a></li>
                        <li><a href="{{route('portal.terminosCondiciones')}}">Términos y Condiciones</a></li>
                    </ul>
                </div>
                <!-- <div class="col-md-2 col-xs-6">
                    <h6 class="font-bold">Autenticación</h6>
                    <ul class="menu-footer mt-40">
                        <li><a href="{{ route('portal.login') }}">Iniciar sesión</a></li>
                        <li><a href="{{ route('registrate.index') }}">Registrarse</a></li>
    ...
    @yield('scripts')
    <script src="{{ asset('portal/assets/js/vendor/modernizr-3.6.0.min.js') }}"></script>
    {{-- <script src="{{ asset('portal/assets/js/vendor/jquery-3.6.0.min.js') }}"></script> --}}
    {{-- <script src="{{ asset('portal/assets/js/vendor/jquery-migrate-3.3.0.min.js') }}"></script> --}}
    <script src="{{ asset('portal/assets/js/vendor/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('portal/assets/js/plugins/waypoints.js') }}"></script>
    <script src="{{ asset('portal/assets/js/plugins/wow.js') }}"></script>
    <script src="{{ asset('portal/assets/js/plugins/magnific-popup.js') }}"></script>
    <script src="{{ asset('portal/assets/js/plugins/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('portal/assets/js/plugins/select2.min.js') }}"></script>
    <script src="{{ asset('portal/assets/js/plugins/isotope.js') }}"></script>
    <script src="{{ asset('portal/assets/js/plugins/scrollup.js') }}"></script>
    <script src="{{ asset('portal/assets/js/plugins/swiper-bundle.min.js') }}"></script>
    <!-- Template  JS -->
    <script src="{{ asset('portal/assets/js/main.js?v=1.0') }}"></script>
