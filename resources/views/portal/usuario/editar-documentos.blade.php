                        ...
                        <div class="sidebar-shadow">
                            ...
                            <div class="card-body">
                                ...
                                <form class="contact-form-style" id="contact-form"
                                    action="{{ route('portal-admin.actualizar-documentos', $documento->id) }}" method="POST"
                                    ...
                                    <div class="row wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                                        ...
                                        <div class="mt-3">
                                            <button class="btn btn-success" type="submit">Actualizar Documentación</button>
