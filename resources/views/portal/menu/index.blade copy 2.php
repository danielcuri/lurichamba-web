...
@section('content')
        ...
        <div class="banner-hero hero-1">
            <div class="banner-inner">
                <div class="banner-imgs">
                    <img alt="jobhub" src="/recursos-sjl/imagenes/ruwani_logo.jpg"
                        style="position: absolute; top: 10%; left: 150px; width:80%" class="img-responsive shape-1" />
                </div>
                    ...
                    <div class="col-lg-5 col-md-6">
                        ...
                        <div class="row d-flex">
                            ...
                            <div class="img-ruwani-mobile">
                                <img alt="jobhub" src="/recursos-sjl/imagenes/ruwani_logo.jpg" style=""
                                    class="" />
                            </div>
                        ...
                        <div class="block-banner form-buscar margin-banner-buscar">
                            ...
                            <div class="form-find mw-720" style="background-color:#C51821">
                                ...
                                <form class="mt-4" style="display:flow-root !important; "
                                    action="/servicio{{ request('search') || request('servicio') ? '?' . http_build_query(request()->except('page')) : '' }}">
                        ...
                        <div class="card-grid hover-up wow animate__animated animate__fadeInUp"
                            ...
                            <div class="text-center">
                                <a href="/servicio?categoria={{ $tipo_servicio->slug }}">
                                    <figure>
                                        <img alt="jobhub" src="{{ Storage::url($tipo_servicio->icono_url) }}" />
                                    </figure>
                                </a>
                            </div>
                            <div>
                                ...
                                <a class="text-white texto-categoria" style="font-weight: 900"
                                    href="/servicio?categoria={{ $tipo_servicio->slug }}">
                                    {{ Str::upper($tipo_servicio->nombres) }}
                                </a>
                            </h5>
                            </div>
                        </div>
                        ...
                        <div class="card-grid hover-up wow animate__animated animate__fadeInUp"
                            ...
                            <div class="row">
                                ...
                                <div class="text-center col-lg-12 col-4">
                                    <a href="/servicio?categoria={{ $tipo_servicio->slug }}" class="text-center">
                                        <figure>
                                            <img alt="jobhub" src="{{ Storage::url($tipo_servicio->icono_url) }}" />
                                        </figure>
                                    </a>
    ...
    {{-- <section class="section-box mt-50 bg-patern" style="background-image: url('recursos-sjl/imagenes/FONDO-SERVICIOS_1920X1080.jpg');background-repeat: no-repeat; background-size: cover;"> --}}
                                    ...
                                    <div class="card-grid-3 hover-up card-gris align-items-stretch">
                                        <div class="card-block-info">
                                            <div class="text-center">
                                                <figure>
                                                    <img alt="jobhub"
                                                        src="{{ asset('recursos-sjl/imagenes/ICONO-USUARIO_100X100.png') }}"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-12 text-center font-bold texto-categoria"
                                                    ...
                                                    <p>{{ $publicacion->personas->nombres }}
                                                        {{ $publicacion->personas->apellido_paterno }}</p>
                                                </div>
                                            </div>
                                            <div>
                                            ...
                                            <div class="card-2-bottom mt-50">
                                                <div class="row d-flex align-items-center justify-content-center">
                                                    <div class="col-lg-6 col-md-12 text-center">
                                                        <a href="{{ route('servicio-portal.show', $publicacion) }}"
    ...
    <section class="section-box mt-50 fondo-imagen-seccion" style="">
        <div class="row">
            {{-- <img alt="jobhub" src="/recursos-sjl/imagenes/1734X2038_PERSONAJE-2.png" class="col-md-3"
                    style="height: 800px; width: 750px; position: absolute; top: 10%; left: 150px; z-index: 2;" /> --}}
